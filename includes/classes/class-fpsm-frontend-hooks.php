...
if ( !class_exists( 'FPSM_Frontend_Hooks' ) ) {
    ...
    class FPSM_Frontend_Hooks {
        ...
        function __construct() {
            ...
            add_action( 'the_content', array( $this, 'append_custom_fields_before' ) );
            add_action( 'the_content', array( $this, 'append_custom_fields_after' ) );
        }
        ...
        function append_custom_fields_before( $content ) {
            ...
            include(FPSM_PATH . '/includes/cores/post-append-content.php');
