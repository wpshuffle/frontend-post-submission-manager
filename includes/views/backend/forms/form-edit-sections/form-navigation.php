<div class="fpsm-form-nav-wrap">
    <ul class="fpsm-form-nav">
        ...
        <?php if ( $form_row->form_type == 'login_require' ) { ?>
            <li><a href="javascript:void(0);" class="fpsm-nav-item" data-tab="login"><span class="dashicons dashicons-lock"></span><?php esc_html_e( 'Login Form Settings', 'frontend-post-submission-manager' ); ?></a></li>
        <?php } ?>
