        ...
        <div class="fpsm-field-wrap fpsm-auto-assign">
            ...
            <div
                ...
                <div class="fpsm-field-wrap">
                    ...
                    <div class="fpsm-field">
                        <select name="<?php echo esc_attr($field_name_prefix) ?>[field_type]"
                            class="fpsm-toggle-trigger" data-toggle-class='fpsm-taxonomy-field-type-ref'>
                            <?php
                ...
                <div class="fpsm-field-wrap fpsm-taxonomy-field-type-ref"
                    ...
                    <div class="fpsm-field">
                        <input type="checkbox" name="<?php echo esc_attr($field_name_prefix) ?>[select_multiple]"
                            value="1"
            ...
            if ($taxonomy_details->hierarchical == 0) {
                ?>
                <div class="fpsm-field-wrap fpsm-taxonomy-field-type-ref"
                    <?php echo $fpsm_library_obj->display_none($field_type, 'textfield'); ?>
                    data-toggle-ref='textfield'>
                    <label><?php esc_html_e('Auto Complete', 'frontend-post-submission-manager'); ?></label>
                    <div class="fpsm-field">
                        <input type="checkbox" name="<?php echo esc_attr($field_name_prefix); ?>[auto_complete]"
                            value="1"
