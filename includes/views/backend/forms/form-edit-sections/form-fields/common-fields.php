<div class="fpsm-field-wrap">
    ...
    <div class="fpsm-field">
        <input type="checkbox" name="form_details[form][fields][<?php echo esc_attr($field_key); ?>][show_on_form]" value="1" <?php echo (!empty($field_details['show_on_form'])) ? 'checked="checked"' : ''; ?> class="fpsm-checkbox-toggle-trigger" data-toggle-class="fpsm-show-fields-ref-<?php echo (!empty($show_hide_toggle_class)) ? esc_attr($show_hide_toggle_class) : esc_attr($field_key); ?>"/>
    </div>
</div>
<div class="fpsm-show-fields-ref-<?php echo (!empty($show_hide_toggle_class)) ? esc_attr($show_hide_toggle_class) : esc_attr($field_key); ?> <?php echo (empty($field_details['show_on_form'])) ? 'fpsm-display-none' : ''; ?>">
    ...
    <div class="fpsm-field-wrap fpsm-required-message <?php echo (empty($field_details['required'])) ? 'fpsm-display-none' : ''; ?>">
        ...
        <div class="fpsm-field">
            <input type="text" name="form_details[form][fields][<?php echo esc_attr($field_key); ?>][required_error_message]" value="<?php echo (!empty($field_details['required_error_message'])) ? esc_attr($field_details['required_error_message']) : ''; ?>"/>
        </div>
    </div>
    <div class="fpsm-field-wrap">
