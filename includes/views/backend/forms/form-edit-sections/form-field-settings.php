    ...
    <div class="fpsm-form-fields-wrap ">
        ...
        <div class="fpsm-form-other-settings">
                ...
                <div class="fpsm-each-form-field">
                    <div class="fpsm-field-head fpsm-clearfix ui-sortable-handle">
                        <h3 class="fpsm-field-title"><span
                                class="dashicons dashicons-arrow-down"></span><?php echo esc_html($post_status_label); ?>
                        </h3>
                    </div>
                    <div class="fpsm-field-body fpsm-display-none">
                        <div class="fpsm-field-wrap">
                            ...
                            <div class="fpsm-field">
                                <input type="checkbox" name="<?php echo esc_attr($field_name_prefix); ?>[enable]"
                                    value="1"
                                    <?php echo (!empty($post_status_details['enable'])) ? 'checked="checked"' : ''; ?>
                                    class="fpsm-checkbox-toggle-trigger"
                                    data-toggle-class="fpsm-show-fields-ref-<?php echo esc_attr($post_status); ?>" />
                            </div>
                        </div>
                        <div
                            class="fpsm-show-fields-ref-<?php echo esc_attr($post_status); ?> <?php echo (empty($post_status_details['enable'])) ? 'fpsm-display-none' : ''; ?>">
                            <div class="fpsm-field-wrap">
                                <label><?php esc_html_e('Label', 'frontend-post-submission-manager'); ?></label>
                                <div class="fpsm-field">
                                    <input type="text" name="<?php echo esc_attr($field_name_prefix) ?>[label]"
                                        value="<?php echo (!empty($post_status_details['label'])) ? esc_attr($post_status_details['label']) : ''; ?>" />
                                </div>
                            </div>
                            <div class="fpsm-field-wrap">
                                ...
                                <div class="fpsm-field">
                                    <input type="text"
                                        name="<?php echo esc_attr($field_name_prefix) ?>[background_color]"
                                        value="<?php echo (!empty($post_status_details['background_color'])) ? esc_attr($post_status_details['background_color']) : ''; ?>"
                                        class="fpsm-color-picker" />
                                </div>
                            </div>
                            <div class="fpsm-field-wrap">
                                ...
                                <div class="fpsm-field">
                                    <textarea
                                        name="<?php echo esc_attr($field_name_prefix) ?>[success_message]"><?php echo (!empty($post_status_details['success_message'])) ? wp_kses_post($post_status_details['success_message']) : ''; ?></textarea>
                                    <p class="description">
                            ...
                            <div class="fpsm-field-wrap">
                                ...
                                <div class="fpsm-field">
                                    <input type="checkbox"
                                        name="<?php echo esc_attr($field_name_prefix); ?>[auto_draft]" value="1"
                                        class="fpsm-checkbox-toggle-trigger"
                            ...
                            <div
                                class="fpsm-field-wrap fpsm-auto-draft-save-time <?php echo (empty($post_status_details['auto_draft_save_time'])) ? 'fpsm-display-none' : ''; ?>">
                            ...
                            <div class="fpsm-field-wrap">
                                ...
                                <div class="fpsm-field">
                                    <input type="checkbox"
                                        name="<?php echo esc_attr($field_name_prefix); ?>[background_save]" value="1"
            ...
            <div class="fpsm-field-wrap">
                ...
                <div class="fpsm-field">
                    <input type="text" name="form_details[form][submit_button_label]"
                        value="<?php echo (!empty($form_settings['submit_button_label'])) ? esc_attr($form_settings['submit_button_label']) : ''; ?>" />
                </div>
            </div>
            <?php
            }
            ...
            <div class="fpsm-field-wrap">
                ...
                <div class="fpsm-field">
                    <input type="text" name="form_details[form][back_button_label]"
                        value="<?php echo (!empty($form_settings['back_button_label'])) ? esc_attr($form_settings['back_button_label']) : '' ?>" />
                    <p class="description">
