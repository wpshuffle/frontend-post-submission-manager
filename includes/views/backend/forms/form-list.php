                    ...
                    foreach ($form_rows as $form_row) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="fpsm-preview" href="<?php echo site_url() . '?fpsm_form_preview=true&fpsm_form_alias=' . esc_attr($form_row->form_alias) . '&_wpnonce=' . wp_create_nonce('fpsm_preview_nonce'); ?>" target="_blank" title="<?php esc_html_e('Preview', 'frontend-post-submission-manager'); ?>"><?php esc_html_e('Preview', 'frontend-post-submission-manager'); ?></a>
