...
<div class="wrap fpsm-wrap">
    ...
    <h2 class="nav-tab-wrapper wp-clearfix fpsm-nav-wrap">
        <a href="javascript:void(0);" class="nav-tab nav-tab-active"><?php esc_html_e( 'Basic Settings', 'frontend-post-submission-manager' ); ?></a>
        <a href="javascript:void(0);" class="nav-tab"><?php esc_html_e( 'Form Fields Settings', 'frontend-post-submission-manager' ); ?></a>
        <a href="javascript:void(0);" class="nav-tab"><?php esc_html_e( 'Display Settings', 'frontend-post-submission-manager' ); ?></a>
        <a href="javascript:void(0);" class="nav-tab"><?php esc_html_e( 'Notification Settings', 'frontend-post-submission-manager' ); ?></a>
        <a href="javascript:void(0);" class="nav-tab"><?php esc_html_e( 'Captcha Settings', 'frontend-post-submission-manager' ); ?></a>
        <a href="javascript:void(0);" class="nav-tab"><?php esc_html_e( 'Customize', 'frontend-post-submission-manager' ); ?></a>
        <?php
        /**
    ...
    <form class="fpsm-form-wrap">
        ...
        ?>
        <div class="fpsm-field-wrap">
            <label><?php esc_html_e( 'Guest Login', 'frontend-post-submission-manager' ); ?></label>
            <div class="fpsm-field">
                <label></label>
            </div>
        </div>
